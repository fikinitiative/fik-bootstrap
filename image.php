			...
			<div id="content" class="clearfix row-fluid">
				...
				<div id="main" class="span8 clearfix" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
						...
						<header> 
							...
							<p class="meta"><?php _e("Posted", "fikstores"); ?> <time datetime="<?php echo the_time('Y-m-j'); ?>" pubdate><?php the_date(); ?></time> <?php _e("by", "fikstores"); ?> <?php the_author_posts_link(); ?>.</p>
						...
						<footer>
							...
							<?php the_tags('<p class="tags"><span class="tags-title">' . __("Tags","fikstores") . ':</span> ', ' ', '</p>'); ?>
				...
				<div id="sidebar1" class="span4 fluid-sidebar sidebar" role="complementary">
					...
					<div class="well">
						...
						<h3><?php _e("Image metadata","fikstores"); ?></h3>
					...
					// Start to display EXIF and IPTC data of digital photograph
					       if ( $imgmeta['image_meta']['created_timestamp'] ) { 
					           echo __("Date Taken","fikstores") . ": " . date("d-M-Y H:i:s", $imgmeta['image_meta']['created_timestamp'])."<br />"; }
					       if ( $imgmeta['image_meta']['copyright'] ) { 
					           echo __("Copyright","fikstores") . ": " . $imgmeta['image_meta']['copyright']."<br />"; }
					       if ( $imgmeta['image_meta']['credit'] ) { 
					           echo __("Credit","fikstores") . ": " . $imgmeta['image_meta']['credit']."<br />"; }
					       if ( $imgmeta['image_meta']['title'] ) { 
					           echo __("Title","fikstores") . ": " . $imgmeta['image_meta']['title']."<br />"; }
					       if ( $imgmeta['image_meta']['caption'] ) { 
					           echo __("Caption","fikstores") . ": " . $imgmeta['image_meta']['caption']."<br />"; }
					       if ( $imgmeta['image_meta']['camera'] ) { 
					           echo __("Camera","fikstores") . ": " . $imgmeta['image_meta']['camera']."<br />"; }
					       if ( $imgmeta['image_meta']['focal_length'] ) { 
					           echo __("Focal Length","fikstores") . ": " . $imgmeta['image_meta']['focal_length']."mm<br />"; }
					       if ( $imgmeta['image_meta']['aperture'] ) { 
					           echo __("Aperture","fikstores") . ": f/" . $imgmeta['image_meta']['aperture']."<br />"; }
					       if ( $imgmeta['image_meta']['iso'] ) { 
					           echo __("ISO","fikstores") . ": " . $imgmeta['image_meta']['iso']."<br />"; }
					       if ( $pshutter ) { 
					           echo __("Shutter Speed","fikstores") . ": " . $pshutter . "<br />"; }
					   ?>
					</div>
